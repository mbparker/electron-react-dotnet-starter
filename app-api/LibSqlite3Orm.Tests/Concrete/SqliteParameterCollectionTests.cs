...
namespace LibSqlite3Orm.Tests.Concrete;
...
public class SqliteParameterCollectionTests
{
    ...
    [Test]
    public void Add_WithNameValueAndType_UsesSerializer()
    {
        // Arrange
        var name = "param1";
        var value = "test";
        ...
        // Act
        var result = _collection.Add(name, value, modelType);

        // Assert
        Assert.That(result, Is.EqualTo(_mockParameter));
        Assert.That(_collection.Count, Is.EqualTo(1));
        _mockParameter.Received(1).UseSerializer(modelType);
        _mockParameter.Received(1).Set(value);
    }

    [Test]
    public void Add_WithNameValueAndSerializer_UsesSerializer()
    {
        // Arrange
        var name = "param1";
        var value = "test";
        ...
        // Act
        var result = _collection.Add(name, value, serializer);

        // Assert
        Assert.That(result, Is.EqualTo(_mockParameter));
        Assert.That(_collection.Count, Is.EqualTo(1));
        _mockParameter.Received(1).UseSerializer(serializer);
        _mockParameter.Received(1).Set(value);
    }

    [Test]
    public void Add_WithNullModelType_DoesNotUseSerializer()
    {
        // Arrange
        var name = "param1";
        var value = "test";
        ...
        // Act
        _collection.Add(name, value, (Type)null);

        // Assert
        _mockParameter.DidNotReceive().UseSerializer(Arg.Any<Type>());
        _mockParameter.Received(1).Set(value);
    }

    [Test]
    public void Add_WithNullSerializer_DoesNotUseSerializer()
    {
        // Arrange
        var name = "param1";
        var value = "test";
        ...
        // Act
        _collection.Add(name, value, (ISqliteFieldSerializer)null);

        // Assert
        _mockParameter.DidNotReceive().UseSerializer(Arg.Any<ISqliteFieldSerializer>());
        _mockParameter.Received(1).Set(value);
    }
