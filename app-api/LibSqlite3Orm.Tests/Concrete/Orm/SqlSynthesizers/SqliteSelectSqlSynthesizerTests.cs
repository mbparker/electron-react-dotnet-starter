...
public class SqliteSelectSqlSynthesizerTests
{
    ...
    {
        // Arrange
        var args = new SynthesizeSelectSqlArgs(false, null, null, null, null, false);
    ...
    public void Synthesize_WithFilterExpression_IncludesWhereClause()
    {
        ...
        var args = new SynthesizeSelectSqlArgs(false, filterExpr, null, null, null, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    public void Synthesize_WithSingleSortSpec_IncludesOrderByClause()
    {
        ...
        var args = new SynthesizeSelectSqlArgs(false, null, sortSpecs, null, null, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    {
        // Arrange
        var args = new SynthesizeSelectSqlArgs(false, null, null, null, 10, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    {
        // Arrange
        var args = new SynthesizeSelectSqlArgs(false, null, null, 5, null, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    {
        // Arrange
        var args = new SynthesizeSelectSqlArgs(false, null, null, 5, 10, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    public void Synthesize_WithAllFeatures_GeneratesCompleteSelectSql()
    {
        ...
        var sortSpec = CreateSortSpec(keySelector, true);
        var sortSpecs = new List<SqliteSortSpec> { sortSpec };
        var args = new SynthesizeSelectSqlArgs(false, filterExpr, sortSpecs, 10, 20, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    public void Synthesize_WithEmptySortSpecs_DoesNotIncludeOrderBy()
    {
        ...
        var args = new SynthesizeSelectSqlArgs(false, null, emptySortSpecs, null, null, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    {
        // Arrange
        var args = new SynthesizeSelectSqlArgs(false, null, null, null, 0, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
    ...
    {
        // Arrange
        var args = new SynthesizeSelectSqlArgs(false, null, null, 0, null, false);
        var sqlArgs = new SqliteDmlSqlSynthesisArgs(args);
